...
const RESOURCE_PACKS = [
  {
    folder: "EaglercraftSounds",
    name: "Eaglercraft Sounds",
    description: "This resource pack is for the original eaglercraft only because laxude (guy that made eaglercraft) made eaglercraft load without sound, so if you want sounds in eaglercraft then download this resource pack and import it into eaglercraft.",
    author: "lax1dude",
    mcVersion: "1.8.x",
    downloadUrl: "https://cdn.jsdelivr.net/gh/UncopylockDomainHere/prism/resourcepacks/EpicAdventures/EpicAdventures1.8.zip",
  },
  {
    folder: "EpicAdventures",
    name: "EpicAdventures 1.8.8",
    description: "As the sun rises over the Minecraft horizon, you see Minecraft in an entirely new light. That’s because with the Epic Adventures resource pack , everything has double the detail. While the default Minecraft resource pack is 16×16 pixels.",
    author: "Toby109tt",
    mcVersion: "1.8.x",
    downloadUrl: "https://cdn.jsdelivr.net/gh/UncopylockDomainHere/prism/resourcepacks/EpicAdventures/EpicAdventures1.8.zip",
  },
